...
const CourseDetailsMain = ({ signInOpen, setSignInOpen }) => {
  ...
  async function getDataCourse() {
    ...
    if (token) {
      ...
      toast.warning("Đăng Nhập! Để xem chi tiết khóa học");
      router.push("/");
    }
  }
  ...
  return (
    <main>
      <Breadcrumb
        ...
        breadcrumbSubTitle="MySQL Database : Beginner SQL Database Design"
      />
                  ...
                  <div className="course-meta-wrapper border-line-meta">
                    <div className="course-meta-img">
                      <Link href="/instructor-profile">
                        <a>
                          <img
                            src="assets/img/course/course-meta.png"
                            alt="course-meta"
                          />
                        </a>
                      </Link>
